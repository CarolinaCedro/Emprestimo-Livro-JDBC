...
public class TabsJFrame extends javax.swing.JFrame {
    ...
    public TabsJFrame() {
        ...
        //this.editoraDao = new ClienteMapDAO();
//        this.editoraDao = new ClienteSetDAO();
    }
...
//        Boolean isCadastrado = editoraDao.cadastrar(cliente);
        ...
        if (isCadastrado) {
            modelo.addRow(new Object[]{cliente.getIdEditora(), cliente.getRazaoSocial(), cliente.getStatus()});
            limparCampos();
        } else {
